...
<body class="black-background"<?php body_class(); ?>>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <nav class="menu-nav">
    <div class="logo">
        <a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo/w_logo.png" alt="Logo"></a>
    </div>
    ...
    <div class="header-action">
        <ul class="list-wrap">
            <li class="header-btn"><a href="#!" class="btn">Contact <span></span></a></li>
                                ...
                                <!-- <nav class="menu-nav">
                                    <div class="logo">
                                        <a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo/w_logo.png" alt="Logo"></a>
                                    </div>
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
